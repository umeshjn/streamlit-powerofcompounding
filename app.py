...
initial_investment = st.sidebar.slider(
    'Initial Investment',
    min_value = 0, max_value = 10000000, value= 1000, step = 1000
)
...
additional = st.sidebar.slider(
    ...
    min_value = 1000, max_value = 10000000, value= 100000, step = 100000
)
...
col1.metric("Initial Investment", str(initial_investment))
col2.metric("Total Additional", str(additional * num_years))
col3.metric("Total Value", str(round((initial_investment * pow(rate_of_return/100 + 1, num_years)) + additional * ((pow(rate_of_return/100 + 1, num_years + 1) - (rate_of_return/100 + 1)) / (rate_of_return/100)), 0)))
